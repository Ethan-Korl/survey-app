...
from auth_backend.backends import BaseSurveyAdminManager, CustomTokenSerializer, SimpleJWTBackend
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            if serializer.is_valid(raise_exception=True):
                ...
                survey_admin = BaseSurveyAdminManager.create_survey_admin(username=username, password=password)
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            if serializer.is_valid(raise_exception=True):
                ...
                admin  = SimpleJWTBackend.authenticate(
                                            username=username,
                                            password=password
                                            )
                if admin is None:
